                        ...
                        <div class="col-12 col-lg-3 col-md-6">
                            <div class="footer-widget">
                                <div class="footer-logo d-flex justify-content-center">
                                    ...
                                    <p class="text-center">Sito realizzato in Laravel
                                </p>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer-bottom-inner d-flex justify-content-center">
                                <div class="copy-right-text py-3">
                                    <p>© 2023 <a href="#">AulabPost</a>. Made with ❤️ by <a target="_blank" rel="noopener" href="https://www.linkedin.com/in/davide-lettera-889535b3/">Davide Lettera</a></p>
                                </div>
