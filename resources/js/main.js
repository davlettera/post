...
//messaggio articolo inserito 4 secondi 
setTimeout(function() {
    
    document.getElementById('success-message').classList.add('d-none');
}, 4000); // nasconde il messaggio dopo 4 secondi (4000 millisecondi)


//batta di ricerca

    // seleziona l'icona di ricerca
    var searchOverlayTrigger = document.getElementById('search-overlay-trigger');
